...
import { idlFactory } from './anchor_registry.did.js';
export { idlFactory } from './anchor_registry.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ANCHOR_REGISTRY;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./anchor_registry.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the anchor_registry canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./anchor_registry.did.js")._SERVICE>}
 */
export const anchor_registry = createActor(canisterId);
